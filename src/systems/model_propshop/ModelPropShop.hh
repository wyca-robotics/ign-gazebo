...
#ifndef IGNITION_GAZEBO_SYSTEMS_MODEL_PROPSHOP_HH_
#define IGNITION_GAZEBO_SYSTEMS_MODEL_PROPSHOP_HH_
...
{
  // Forward declaration
  class ModelPropShopPrivate;

  /// \brief The ModelPropShop system computes lift and drag forces enabling
  ...
  ///               stall.
  class IGNITION_GAZEBO_VISIBLE ModelPropShop
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: ModelPropShop();

    /// \brief Destructor
    public: ~ModelPropShop() override = default;
    ...
    private: std::unique_ptr<ModelPropShopPrivate> dataPtr;
  };
  }
}
}
